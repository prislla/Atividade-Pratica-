...
$form_html = <<<HTML
    ...
    <form action="/?contacts" method="post" name="contacts" id="contacts">
        ...
        <p>Preencha todos os campos abaixo para enviar um contato para a equipe do <strong>Costura Criativa</strong>.</p>
...
<aside>
  ...
  <nav class="social">
    <a href="https://facebook.com/CosturaCriativa" target="_blank" title="Facebook">
      <i class="fa-brands fa-facebook fa-fw fa-3x"></i>
    </a>
    <a href="https://youtube.com/CosturaCriativa" target="_blank" title="Youtube">
      <i class="fa-brands fa-youtube fa-fw fa-3x"></i>
    </a>
    <a href="https://github.com/CosturaCriativa" target="_blank" title="GitHub">
      <i class="fa-brands fa-github fa-fw fa-3x"></i>
    </a>
    <a href="mailto:costuracriativa@cria.com.br" target="_blank" title="E-mail">
      <i class="fa-solid fa-envelope fa-fw fa-3x"></i>
    </a>
    <a href="https://wa.me/5521985685543" target="_blank" title="WhatsApp">
      <i class="fa-brands fa-whatsapp fa-fw fa-3x"></i>
    </a>
    <a href="tel://5521985685543" target="_blank" title="Telefone">
